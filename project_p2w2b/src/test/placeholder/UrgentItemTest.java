...
public class UrgentItemTest {
    ...
    public void getIsUrgentResultTest() {
        assertEquals("URGENT!!!",item1.getIsUrgentResult());
    }
    ...
    public void getResultTest() {
        assertEquals("URGENT!!!  Item: one Status: ToDo Due Data: 05 / 10 / 2019",item1.getResult());
    }
    ...
    public void toStringTest() {
        String u = item1.toString();
        assertEquals("UrgentItem : name = one",u);
    }
}
